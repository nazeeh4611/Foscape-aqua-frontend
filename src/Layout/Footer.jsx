        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/" target="_blank" className="bg-blue-600 p-3 rounded-full hover:bg-blue-700 transition-colors">
                <Facebook size={20} />
              </a>
              <a href="https://www.instagram.com/foscape_stories/" target="_blank" className="bg-blue-600 p-3 rounded-full hover:bg-blue-700 transition-colors">
                <Instagram size={20} />
              </a>
              <a href="https://www.youtube.com/@foscape_stories" target="_blank" className="bg-blue-600 p-3 rounded-full hover:bg-blue-700 transition-colors">
                <Youtube size={20} />
              </a>
            </div>
          </div>
...
<div>
  ...
  <ul className="space-y-4">
    ...
    <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-300">FOSCAPE, 4/46B, juma masjid, PV BUILDING, V HAMZA ROAD,NADUVILANGADI, Tirur, Kerala 676107</span>
              </li>
